...
def collect_env_info():
    ...
    try:
        from centernet import _C
    except ImportError:
        data.append(("centernet._C", "failed to import"))
    else:
        data.append(("centernet Compiler", _C.get_compiler_version()))
        data.append(("centernet CUDA Compiler", _C.get_cuda_version()))
