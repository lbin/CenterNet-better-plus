...
def setup_logger(
    output=None, distributed_rank=0, *, color=True, name="centernet", abbrev_name=None
):
    """
    ...
    Args:
        ...
        abbrev_name (str): an abbreviation of the module, to avoid long names in logs.
            ...
            By default, will abbreviate "centernet" to "d2" and leave other
            modules unchanged.
    """
    ...
    if abbrev_name is None:
        abbrev_name = "c2" if name == "centernet" else name
