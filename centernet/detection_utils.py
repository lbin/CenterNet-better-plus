...
from detectron2.structures import BitMasks, Boxes, Instances, Keypoints, PolygonMasks
...
def transform_keypoint_annotations(keypoints, transforms, image_size, keypoint_hflip_indices=None):
    ...
    Args:
        keypoints (list[float]): Nx3 float in centernet Dataset format.
        transforms (TransformList):
        image_size (tuple): the height, width of the transformed image
        keypoint_hflip_indices (ndarray[int]): see `create_keypoint_hflip_indices`.
    """
...
def gen_crop_transform_with_instance(crop_size, image_size, instance):
    ...
    Args:
        ...
        instance (dict): an annotation dict of one instance, in centernet's
            dataset format.
    """
